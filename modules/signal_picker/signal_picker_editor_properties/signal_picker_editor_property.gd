...
var current_value = preload("res://addons/reuse_logic_nexus/modules/signal_picker/signal_picker_classes/signal_picker.gd").new() as SignalPicker
...
func _init(obj = null, prop = null):
	...
	if _brain:
		...
		push_warning("Any Node using SignalPicker must be a child of the Brain node for the SignalPicker to work properly.")
...
func _update_property():
	...
	if new_value:
		new_value = new_value as SignalPicker
