...
var current_value = preload("res://addons/reuse_logic_nexus/modules/signal_picker/signal_picker_classes/signal_picker_child.gd").new() as SignalPickerChild
...
func _init(obj = null, prop = null):
	...
	if _brain:
		...
		push_warning("Any Node using SignalPickerChild must be the parent of the Brain node for the SignalPickerChild to work properly.")
...
func _update_property():
	...
	if new_value:
		new_value = new_value as SignalPickerChild
